...
public:
	...
	//inline Vec3 Normalize() { D3DXVec3Normalize(this, this); return *this; }
	//inline void Normalize() { return static_cast<Vec3 *>(D3DXVec3Normalize(this, this)); }
...
inline float Dot(const Vec3 &a, const Vec3 &b) { return D3DXVec3Dot(&a, &b); }
////////////////////////////////////////////////////
//
// Vec4 Description
//
